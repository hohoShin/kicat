...
from .views import (
    HomeView,
    AboutView,
    ServiceInterpretationView,
    ServiceTranslationView,
    ServiceAIView,
    ServiceAIv2View,
    ServiceAIv3View,
    ServiceOthersView,
...
urlpatterns = [
    ...
    path(
        ...
        ServiceInterpretationView.as_view(),
        name="service_interpretation",
    ),
    path(
        "service-translation",
        ServiceTranslationView.as_view(),
        name="service_translation",
    ),
    path("service-ai", ServiceAIView.as_view(), name="service_ai"),
    path("service-ai-v2", ServiceAIv2View.as_view(), name="service_ai_v2"),
    path("service-ai-v3", ServiceAIv3View.as_view(), name="service_ai_v3"),
