...
class ServiceAIView(TemplateView):
    template_name = "core/service-ai.html"
    http_method_names = ["get"]


class ServiceAIv2View(TemplateView):
    template_name = "core/service-ai-v2.html"
    http_method_names = ["get"]


class ServiceAIv3View(TemplateView):
    template_name = "core/service-ai-v3.html"
    http_method_names = ["get"]
